CXXFLAGS = -D_DEBUG  -ggdb -g3  -std=c++17 -Og -Wall -Wextra -pie -fPIE -Werror=vla       \
...
diff: clean_dump build build_diff main_diff.o struct_diff.o differenciator.o simplify_diff.o connect_tree_diff.o read_diff.o dump_diff.o duplicate_diff.o my_stdio.o logging.o print_error.o
